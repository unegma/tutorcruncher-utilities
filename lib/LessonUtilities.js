...
class LessonUtilities extends BaseUtilities {
   ...
   */
  getFullLessons = async (lessonIdsArray, delayIncrement = 300, logOutput = false) => {
    console.log('Getting Full Lessons');
    return await this.getFullItems(lessonIdsArray, delayIncrement, this.getLesson.bind(this), logOutput);
  }
