...
class JobUtilities extends BaseUtilities {
   ...
   */
  getFullJobs = async (jobsIdsArray, delayIncrement = 300) => {
    console.log('Getting Full Jobs');
    return await this.getFullItems(jobsIdsArray, delayIncrement, this.getJob.bind(this));
  }
