...
class PaymentUtilities extends BaseUtilities {
  ...
  getFullAdHocCharges = async (adHocChargeIdsArray, delayIncrement = 300) => {
    ...
    return await this.getFullItems(adHocChargeIdsArray, delayIncrement, this.getAdHocCharge.bind(this));
  }
  ...
  getFullPFIs = async (pfiIdsArray, delayIncrement = 300) => {
    ...
    return await this.getFullItems(pfiIdsArray, delayIncrement, this.getPFI.bind(this));
  }
